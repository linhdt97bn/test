    ...
    <div id="copyrights">
        <div class="container clearfix">
            ...
            <div class="col_half col_last tright">
                ...
                <div class="clear"></div>
                <i class="icon-envelope2"></i> <span class="__cf_email__" data-cfemail="3c55525a537c5f5d524a5d4f125f5351">[project1@gmail.com]</span> <span class="middot">&middot;</span> <i class="icon-headphones"></i> +0123456789 <span class="middot">&middot;</span> <i class="icon-skype2"></i> Project 1
            </div>
        </div>
    </div>
</footer>
